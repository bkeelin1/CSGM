...
#'
#' @param object An object resulting from either the \code{pred}, \code{PSLR},
...
#' \code{PSLR} and \code{pred} functions as well as conducts an internal function
...
summary <- function(object,
  ...
  if("pred" %in% class(object)) {
    print("Summary Statistics from the pred Function:")
    cat("\n")
    cat("\n")
