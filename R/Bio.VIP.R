...
#'
#' @returns A list of class "Bio.VIP" containing:
#' \itemize{
...
Bio.VIP <- function(Models = NULL,
  ...
  if (isTRUE(print_progress)) {
    pb$tick(5, tokens = list(what = "Starting Bio.VIP Modeling"))
  }
  #______________________________________________________________________________________________________________________
  ...
  if (isTRUE(print_progress)) {
    pb$tick(5, tokens = list(what = "Bio.VIP paramters set"))
  }
